...
public sealed class MrMixTypingChallengeHud : PanelComponent
{
	...
	[Property] public float TimeLimitSeconds { get; set; } = 60f;
	[Property] public int WordsToWin { get; set; } = 25;
	[Property] public string LevelLabel { get; set; } = "Level 3";
	[Property] public float WinAutoNextDelaySeconds { get; set; } = 9f;
	[Property] public string NextLevelScenePath { get; set; } = "scenes/level4.scene";
	...
	{
		"pepper", "banana", "egg", "broccoli", "strawberry", "onion", "ketchup", "lettuce", "cucumber", "tomato", "pear", "cherry", "carrot", "kiwi", "salt", "milk", "apple" 
	};
