...
public sealed class MrMixTypingChallengeHud : PanelComponent
{
	...
	[Property] public float TimeLimitSeconds { get; set; } = 350f;
	[Property] public int WordsToWin { get; set; } = 100;
	[Property] public string LevelLabel { get; set; } = "Level 5";
	[Property] public float WinAutoNextDelaySeconds { get; set; } = 9f;
	[Property] public string NextLevelScenePath { get; set; } = "scenes/level6.scene";
	...
	{
		"pepper", "banana", "egg", "broccoli", "strawberry", "onion", "ketchup", "lettuce", "cucumber", "tomato", "pear", "cherry", "carrot", "kiwi", "salt", "milk", "apple", "potato", "salad", "biscuit", "butter", "choco", "coconut", "garlic", "flower"
	};
